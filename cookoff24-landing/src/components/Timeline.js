...
const Timeline = () => {
  ...
  return (
    <div className="h-[100vh] relative">
      <div className="text-lg font-normal tracking-[7px] ml-40 text-grey ">
        TIMELINE
      </div>
        ...
        {events.map((e, index) => {
          return (
            <motion.div
              ...
              className={`flex ml-40 h-[${
                100 / events.length
              }%] border-b-2 border-grey gap-44 text-grey text-3xl font-semibold z-20 px-10`}
              whileHover={{
