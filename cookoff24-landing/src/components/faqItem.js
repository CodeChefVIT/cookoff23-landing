  ...
  return (
    <>
      <motion.div
        ...
        className={`flex flex-wrap justify-between items-center px-[200px] pt-7 ${
          isHovered
            ? `bg-[#eb5939] duration-300 pb-24`
            : `bg-transparent duration-300`
        }`}
      >
        <motion.div className="mx-[200px]"></motion.div>
        <div className="flex justify-center items-end">
          ...
          <div
            className={`text-[32px] font-bold mx-10 w-[600px] ${
              isHovered
        ...
        <motion.div className="w-[800px] text-[18px] text-[#0d0d0d] font-semibold mx-[150px] mt-3">
          {answer}
        </motion.div>
      </motion.div>

      <div className="flex w-full justify-center">
        <div className="flex border-b-[2px] border-[#AA9E8B] opacity-30 w-[75%]" />
      </div>
    </>
  );
};
